...
The bounds of data exploration with Cinema are limited only by one's imagination.  Details of the Cinema database Specification versions are in Specifications and the Cinema Viewers are described in Viewers.  
