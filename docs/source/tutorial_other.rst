...
The cinema_lib library can be used to upgrade a Spec A CDB.  Follow the instructions for downloading and installing from the `cinema_lib`_ Github page.  Included in that download is a **upgrade_cinema_database** script:
